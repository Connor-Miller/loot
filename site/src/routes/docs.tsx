...
const CLI: Array<{ id: string; group: string; verbs: Verb[] }> = [
	...
	},
	{
		...
		verbs: [
			...
			{ cmd: 'loot verify [--accept-loss]', desc: 'Integrity-check the object store: rehash every object, name missing ones by referencing change. Exits 1 on problems; --accept-loss records unrecoverable losses so only new damage fails.' },
